...
mongoose.connect("mongodb+srv://harshagym:Harsha2002@gym0.2z9zndo.mongodb.net/Gym0", {
...
//creating end points for newCollections
...
//creating end points for popular
app.get('/popular',async(req,res)=>{
    let products=await Product.find({category:"T-Shirts"});
    let populars=products.slice(0,4);
    console.log("Populars are fetched");
    res.send(populars);
})

// creating middleware for the users
...
app.post('/addtocart', fetchUser, async (req, res) => {
    ...
    try {
        ...
        await Users.findOneAndUpdate({ _id: req.user.id }, { $set: { cartData: userData.cartData } });
